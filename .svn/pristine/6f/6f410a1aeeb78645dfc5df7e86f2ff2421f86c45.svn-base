...
angular.module('myApp', 
        ['ionic','ngCordova','ngTouch',
         ...
         'myApp.envAnalyIndex','myApp.tempHumi','myApp.tempDiff','myApp.CO2','myApp.light','myApp.alerts',
