...
<body>
	<table id="House_table" class="easyui-datagrid" title="实时上传数据" style="width:1000px"
		...
		<thead>
			<tr>
				<th data-options="field:'keyid',width:100,halign:'center'">KeyId</th>
				<th data-options="field:'bak1',width:100,halign:'center'">IMEI</th>
				<th data-options="field:'bak2',width:100,halign:'center'">ICCID</th>
